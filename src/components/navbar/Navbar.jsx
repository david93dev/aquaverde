    ...
    <header className="flex justify-center fixed w-full z-50">
      <div className="w-full md:mx-5 bg-primary h-16 rounded-b-2xl px-6 md:px-8 flex justify-between items-center shadow-md border-b border-[#006386]">
        ...
        <button
          ...
          className="p-2 rounded-md hover:bg-primary-dark transition"
        >
        ...
        <div
          className={`absolute top-16 right-4 py-2 bg-primary text-secondary rounded-b-xl min-w-56 shadow-lg overflow-hidden transform transition-all duration-300 ${
            showMenu
